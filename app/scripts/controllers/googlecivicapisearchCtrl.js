...
/**
 * @ngdoc function
 * @name everyvoteTuresoApp.controller:GooglecivicapisearchCtrl
 * @description
 * # GooglecivicapisearchCtrl
 * Controller of the everyvoteTuresoApp
 */
angular.module('everyvoteTuresoApp')
  .controller('googlecivicapisearchCtrl', function ($scope, $q, ElectionModelOrchestrator) {

    var self = this;

    this.getVoterInfoQuery = function() {
